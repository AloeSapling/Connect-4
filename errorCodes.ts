export const ERROR_CODES = ["ServerError", "BadLobbyCode", "BadData", "BadTurn", "LobbyCreateFail", "Unauthorised", "NotAMember", "GameAlreadyExists", "GameLocked", "GameExpired", "AlreadyJoined"] as const;
