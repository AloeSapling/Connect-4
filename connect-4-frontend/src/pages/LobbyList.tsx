...
function LobbyList() {
    ...
    return (
        <div className="w-11/12 max-w-6xl p-4 flex flex-col bg-yellow-800/80 text-white rounded-lg min-h-120">
            ...
            >
                <div className="flex flex-col gap-6 min-h-0 overflow-hidden">
                    {queryData && (
                        <>
                            <LobbyTable lobbyData={queryData.myLobbies ?? []} title={texts.myLobbies} navigateOnly />
